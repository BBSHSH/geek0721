...
public final class ActivityAccoutBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static ActivityAccoutBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityAccoutBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_accout, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityAccoutBinding bind(@NonNull View rootView) {
